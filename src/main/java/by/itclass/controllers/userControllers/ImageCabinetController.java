...
@WebServlet(name = "ImageCabinetController", value = AppConstant.UPLOAD_IMAGE_CABINET_CONT_URL)
public class ImageCabinetController extends AbstractUserController {
