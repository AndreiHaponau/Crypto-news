    ...
    <div class="row">
        ...
        <div class="col-md-4 m_corr text_center">
            ...
            <form method="post" action="<c:url value="/auth"/>">
                <input type="text" class="form-control" name="<%= AppConstant.EMAIL_LABEL %>"
                       placeholder="Введите имя/почту"><br>
                <input type="password" class="form-control" name="<%= AppConstant.PASSWORD_LABEL %>"
