				...
				<div class="main_news">
					...
					<p> &nbsp;
						<span class="right_date">
							${DateUtil.format(newsList.get(0).date, DateUtil.DD_MM_YYYY_HH_MM)}
						</span>
					</p>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-8">
								...
								<p>
									${news.text}
									<br>
									<a href="<c:url value="<%= AppConstant.GET_NEWS_CONT_URL %>"/>?action=view&id=${news.id}">читать далее...</a>
								<p> &nbsp;
									<span class="right_date">
											${DateUtil.format(news.date, DateUtil.DD_MM_YYYY_HH_MM)}
									</span>
								</p>
							</div>
						</div>
